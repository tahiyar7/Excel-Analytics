...
find_text: The text you want to find.
within_text: The text containing the text you want to find.<br />
start_num: (Optional) The character number in within_text at which to start the search.<br />
...
LEFT, RIGHT, MID: Extract a specified number of characters from a string.<br />
LEN: Returns the number of characters in a string.
TRIM: Removes all spaces from a text string except for single spaces between words.<br />
UPPER, LOWER, PROPER: Convert text to uppercase, lowercase, or proper case.<br />
...
FORECAST.ETS: Returns a future value based on existing (historical) values using the AAA version of the Exponential Smoothing (ETS) algorithm.<br />
